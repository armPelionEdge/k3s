...
type Message_OpenPayload struct {
	OpenPayload *OpenPayload `protobuf:"bytes,2,opt,name=open_payload,json=openPayload,proto3,oneof"`
}

type Message_ClosePayload struct {
	ClosePayload *ClosePayload `protobuf:"bytes,3,opt,name=close_payload,json=closePayload,proto3,oneof"`
}
...
func (m *OpenPayload) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpenPayload.Merge(m, src)
}
...
type ClosePayload struct {
	Code                 ClosePayload_CloseCode `protobuf:"varint,1,opt,name=code,proto3,enum=ClosePayload_CloseCode" json:"code,omitempty"`
...
func (m *ClosePayload) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClosePayload.Merge(m, src)
}
